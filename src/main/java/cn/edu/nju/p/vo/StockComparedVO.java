...
public class StockComparedVO {
     ...
     * @param dateList 日期的集合
     */
    public StockComparedVO(String stockCode,String stockName,double highest, double lowest, boolean hasIncreased, double amountOfChange, ArrayList<Double> closeList, ArrayList<Double> logList, double squareDifference,List<LocalDate> dateList) {

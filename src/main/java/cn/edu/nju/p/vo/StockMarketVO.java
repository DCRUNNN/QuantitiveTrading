...
public class StockMarketVO {
    ...
    public StockMarketVO(long volume, int amountOfLimitUp, int amountOfLimitDown, int amountOf5PercentUp, int amountOf5PercentDown, int amountOf5PercentUptolastClose, int amountOf5PercentDowntolastClose) {
        this.volume = volume;
